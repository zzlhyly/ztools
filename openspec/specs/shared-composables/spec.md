...
Extract repeated clipboard copy logic into a shared `useClipboard` composable, eliminating the 14 identical `handleCopy` functions duplicated across tool components. Any new tool can use clipboard functionality in one import.
